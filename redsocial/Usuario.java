...
public class Usuario {
	...
	/**
	 * Devuelve si un usuario tiene un mensaje
	 * 
	 * @param mensaje, mensaje que puede tener o no el usuario
	 * @return boolean, true si contiene el mensaje, false en caso contrario
	 */
	public boolean contieneMensaje(Mensaje mensaje) {
	...
	public String toString() {
		return "@"+this.nombre+"("+this.amplificacion+") "+this.enlacesDirectos + " Exposición:" + this.exposicion + " " + this.mensajes;
	}
}
